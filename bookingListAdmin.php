...
<head>
  ...
  <link rel="stylesheet" href="css/bookingListAdmin.css">
</head>
        ...
        <table>
          ...
          <tbody>
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit'])) {
              ...
              handleFormSubmission($conn, ['id', 'username', 'organization', 'facility', 'purpose', 'date', 'start_time', 'end_time', 'status', 'checkbox'], 0, 0);
            } else {
              fetchAllBooking($conn, ['id', 'username', 'organization', 'facility', 'purpose', 'date', 'start_time', 'end_time', 'status', 'checkbox'], 0 ,0);
            }
            ?>
          </tbody>
        </table>
